...
input_dev = raw_input('enter device name: ')
input_param_dyn = raw_input('enter param: ' + str(london_co.get(input_dev, 'Oops').keys()))
print(london_co.get(input_dev, 'Oops').get(input_param_dyn.lower(), 'Oops'))
